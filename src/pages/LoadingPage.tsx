      ...
      <div className="w-full flex justify-center" style={{ background: '#F4FBF2' }}>
        <div className="p-6" style={{ width: '1440px', maxWidth: '1440px', minWidth: '1440px' }}>
          <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            {/* Scanning Analysis Cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl">
              <div className="flex items-start gap-3">
                <RiSearchLine size={20} style={{ color: DARK_PALETTE.primary }} />
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-1">Page Structure Analysis</h4>
                  <p className="text-xs text-gray-600">Examining site navigation and content</p>
                </div>
              </div>

              <div className="flex items-start gap-3">
                <RiBarChartLine size={20} style={{ color: DARK_PALETTE.primary }} />
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-1">Performance Check</h4>
                  <p className="text-xs text-gray-600">Testing load speeds and optimization</p>
                </div>
              </div>

              <div className="flex items-start gap-3">
                <RiRocketLine size={20} style={{ color: DARK_PALETTE.primary }} />
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-1">Conversion Analysis</h4>
                  <p className="text-xs text-gray-600">Reviewing user experience flows</p>
                </div>
              </div>

              <div className="flex items-start gap-3">
                <RiSettings3Line size={20} style={{ color: DARK_PALETTE.primary }} />
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-1">Final Report Generation</h4>
                  <p className="text-xs text-gray-600">Compiling recommendations and fixes</p>
                </div>
              </div>
            </div>
          </div>
